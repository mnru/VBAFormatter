...
Sub addButton()
  ...
  Set wVBAFormatterMenu = Application.VBE.CommandBars("���j���[ �o�[").Controls.Add(Type:=msoControlPopup, ID:=1)
  ...
  wFormatExecMenu.Caption = "�t�H�[�}�b�g���s(&F)..."
  wOptionMenu.Caption = "�I�v�V����(&O)..."
...
Sub dellButton()
  ...
  For Each wCtrl In Application.VBE.CommandBars("���j���[ �o�[").Controls
    If wCtrl.ID = 1 Then
      wCtrl.Delete
      Exit Sub
    End If
